...
function getCommitSha(branchId) {
	var commitInfo =
		"https://api.github.com/repos/Microsoft/TypeScript-TmLanguage/branches/" +
		branchId;
...
exports.update = function (branchId, repoPath, dest, modifyGrammar) {
	var contentPath =
		"https://raw.githubusercontent.com/Microsoft/TypeScript-TmLanguage/" +
		branchId +
		"/" +
		repoPath;
			...
			try {
				...
				if (info) {
					console.log(
						"Updated " +
							path.basename(dest) +
							" to Microsoft/TypeScript-TmLanguage@" +
